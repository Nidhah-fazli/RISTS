...
public class PorterStemmer {
    ...
    private char[] b;
    private int i, i_end, /* offset into b */
    j, k, k0;
    ...
    */
    public String stem(char[] s, int length) {
        char[] sc = (char[]) s;
        if (!stem(sc, sc.length).equals(""))
            return toString();
        else
            return s.toString();
    }
    ...
    */
    public static void main(String[] args) {
        ...
        for (int i = 0; i < args.length; i++) {
            try {
                try (InputStream in = new FileInputStream("C:\\Users\\Nowshad\\Desktop\\pythont.txt")) {
